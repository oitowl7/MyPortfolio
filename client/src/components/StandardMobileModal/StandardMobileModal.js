...
import { Header, Modal, Image, Container, Grid, Tab, List, Divider, Segment } from 'semantic-ui-react';
import cardData from "../../utils/StandardMobileInfo"

const StandardMobileModal = props => {
  const style = {
    secondary: {
  ...
  return (
    <div id="portfolio">      
      <Container style={{backgroundColor: props.primaryColor, color: props.secondaryColor}}>
        <Header as="h2" style={style.secondary}>Portfolio</Header><Header as="h4" style={{color: props.secondaryColor}}>(Click the Images for More Information)</Header><br></br>
        <Grid stackable>
          <Grid.Row columns={1}>
            {cardData.map( (card, i) => {
              return(
              <Grid.Column key={i}>
                      ...
                      <Grid>
                        <Grid.Row>
                          <Grid.Column width={16}>
                            <Tab className="standardMenu mobileMenuUser" menu={{ pointing: true }} panes={[
                ...
                <Container>
                  <Divider style={{color: props.secondaryColor, backgroundColor: props.secondaryColor}}/>
                </Container>
              </Grid.Column>
            )})}
          </Grid.Row>
...
export default StandardMobileModal